...
ALTER TABLE `jobs`.`inscricoes`
  ADD CONSTRAINT `fk_inscricoes_vagas` FOREIGN KEY (`id_vaga`) REFERENCES `jobs`.`vagas` (`id`);
...
ALTER TABLE `cadastro` ADD `curriculo` VARCHAR(255) NULL AFTER `foto`;

ALTER TABLE `vagas` ADD `Cidade` VARCHAR(50) NULL AFTER `usuario_responsavel`;
