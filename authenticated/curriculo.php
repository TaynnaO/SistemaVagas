...
echo "<header style='background:#030253; margin-top:-10px; padding:5px;'>
    <ul>
  ...
  <a href='./logout.php'><li>Sair</li></a>
    ...
    echo "<header style='background:#0300253; margin-top:-10px; padding:5px;'>
      <ul>
          <a href='../authenticated/home.php'> <li>
...
<body>
    <div class="container">
        ...
        <form action="gerar_curriculo.php" method="post">
            ...
            <textarea id="experiencia" name="experiencia" rows="6" required></textarea>

            <label for="formacao">Formação Acadêmica:</label>
            <textarea id="formacao" name="formacao" rows="4" required></textarea>
