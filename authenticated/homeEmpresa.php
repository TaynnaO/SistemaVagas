...
echo "<header>
    <ul>
        <a href='../authenticated/home.php'> <li>
            <img src='..\imagens\jmtg__2_-removebg-preview.png' width:120px height:100px alt=''class='logo'> 
        </li></a> 
  ...
  <a href='perfilEmpresa.php'><li>Editar perfil da empresa</li></a>
  ...
  <a href='./logout.php'><li>Sair</li></a>
    ...
    echo "<header>
      <ul>
          <a href='../authenticated/home.php'> <li>
              <img src='..\imagens\jmtg__2_-removebg-preview.png width:120px height:120px alt=''class='logo'> 
          </li></a> 
        </li></a>
        <a href='../authenticated/cadastroVagas.php'> <li>Cadastrar vaga</li></a>
        <a href='../authenticated/vagasCriadas.php'><li>Minhas vagas</li></a>
    ...
    <ul class='dropdown-menu'>
    <a href='perfil.php'><li>Editar perfil da empresa</li></a>
    <a href='./logout.php'><li>Sair</li></a>
    </ul>
  </div>
...
$('.btn-baixar').on('click', Visualizar perfil);
