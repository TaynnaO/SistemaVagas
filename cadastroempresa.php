...
<body>
    <div class="imagem-cadastro">
        ...
        <h1 class="subtitle">O caminho para o seu sucesso começa aqui!</h1>
    </div>
...
<form action="validaCadastro.php" method="POST">
  <div class="tab">
    ...
    <button class="tablinks" onclick="openTab(event, 'tab2')">Dados</button>
  ...
  <div id="tab1" class="tab-content active">
      ...
      <div class="cadastro-inicial">
        ...
        <input type="text" placeholder="Digite o nome de sua empresa" name="nome" >
        </div>
        <div class="caixa-input">
        <label for="email">Email</label>
        <input type="email" placeholder ="Digite o email de sua empresa" name="email" required></div>
        <div class="caixa-input">
...
<input type="button" value="Próximo" onclick="nextTab()">        
  ...
  <div id="tab2" class="tab-content">
    ...
    <div id="dadosPessoais">
        ...
        <input type="text" placeholder="Digite o numero de telefone" name="celular">
        </div>
        </div>
